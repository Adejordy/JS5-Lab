...
console.log(
  `On July 20th, ${person.year}, ${person.firstname} ${person.lastname} was the first person to set foot on the moon.`
);
/*-------------------------------------------------------*/
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting("Alyssa", "Arizona");
myGreeting.hello();
/*-------------------------------------------------------*/
// Question 3: myBook
console.log(`--------------------------
...
let yourBook = new Book("My Best Friend's Exorcism", "Grady Hendrix");
...
class Fruit {
  ...
  describe() {
    return `This is a ${this.name} that is ${this.color} and taste ${this.taste}`;
  }
}
